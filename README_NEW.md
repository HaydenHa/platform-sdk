...
5 | 3.7 回款记录查询：Response | "usernamep": "string, 合作平台用户名",<br />"createTime": "string, 回款计划生成时间",<br />"repayPlan": "array, 回款计划明细",<br />"expectAmount": "float, 预期回款金额(本金)",<br />"expectIncome": "float, 预期回款金额(本金)",<br />"repayDate": "datetime, 实际回款时间",<br />"status": "enum，回款状态，见回款状态表格" | "id": "string, 回款ID，全局唯一"
